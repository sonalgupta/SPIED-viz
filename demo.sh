...
java -cp $CLASSPATH:lib/*:pos-models/* edu.stanford.nlp.patterns.surface.GetPatternsFromDataMultiClass -props properties/example.properties -identifier UsingNERTargetRest                 -useTargetNERRestriction true

#Run second system without using the NER restriction
java -cp $CLASSPATH:lib/*:pos-models/* edu.stanford.nlp.patterns.surface.GetPatternsFromDataMultiClass -props properties/example.properties -identifier NotUsingNERTargetRest -useTargetNERRestriction false
